...
import (
	...
	"github.com/ideadevice/grdp/protocol/nla"

	"github.com/ideadevice/grdp/core"
	"github.com/ideadevice/grdp/emission"
	"github.com/ideadevice/grdp/glog"
	"github.com/ideadevice/grdp/protocol/lic"
	"github.com/ideadevice/grdp/protocol/t125"
	"github.com/ideadevice/grdp/protocol/t125/gcc"
)
...
func generateKeys(clientRandom, serverRandom []byte, method uint32) ([]byte, []byte, []byte) {
	...
	glog.Debug("preMasterHash:", string(preMasterHash))
...
func (c *Client) sendClientRandom() {
	...
	glog.Debug("clientRandom:", string(clientRandom))

	serverRandom := c.ServerSecurityData().ServerRandom
	glog.Debug("ServerRandom:", string(serverRandom))
